...
class CorrectBallDetector(Node):
    def __init__(self):
        super().__init__('correct_ball_detector')
    ...
    def process_tennis_ball(self, cv_image, msg, ball_data, ball_number):
        ...
        # Skip if depth is less than 0.6m
        if depth_mm < 600:
            return False
    ...
    def create_debug_visualization(self, cv_image, detected_balls):
        ...
        for i, ball_data in enumerate(detected_balls):
            ...
            if depth_m < 0.6:
                continue  # Skip visualizing balls below threshold
            color = (0, 255, 0)
